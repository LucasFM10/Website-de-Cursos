...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Adribacci — Cursos de crochê e bolsas artesanais" },
      {
        name: "description",
        content:
          "Ateliê Adribacci: cursos de crochê em vídeo e bolsas feitas à mão, peça por peça.",
      },
      { name: "author", content: "Adribacci" },
      { property: "og:title", content: "Adribacci — Cursos de crochê e bolsas artesanais" },
      {
